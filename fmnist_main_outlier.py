...
for rep in range(n_rep):
    ...
    for lab in present_label:
        ...
        model_save_file = 'fmnist_param/' + f'{timestamp}_'+ 'class' + str(lab) + '.pt'
    ...
    for lab in all_label:    
        ...
        for pidx in range(len(present_label)):
            ...
            model_save_file = 'fmnist_param/' + f'{timestamp}_'+ 'class' + str(present_label[pidx]) + '.pt'
            netI.load_state_dict(torch.load(model_save_file))
...
import pickle
filename = f'outputs/FMNIST/resnet18_outlier_{timestamp}.pkl'
