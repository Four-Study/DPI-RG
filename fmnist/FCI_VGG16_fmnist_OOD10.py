...
momentum            = 0.9
weight_decay        = 5e-4
lams                = [1.0, 3.0, 5.0, 5.0, 0.6] # coefficients for all losses
...
#         netG_A2B.conv1   = nn.Conv2d(nc, Net.conv1.weight.shape[0], 3, 1, 1, bias=False) 
...
with open('FCI_VGG16_fmnist_OOD10.pkl', 'wb') as out:
    pickle.dump(res, out)
