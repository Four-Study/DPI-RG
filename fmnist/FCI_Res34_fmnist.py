...
momentum            = 0.9
weight_decay        = 5e-4
lams                = [1.0, 3.0, 5.0, 5.0, 1.0] # coefficients for all losses
...
all_label     = missing_label + present_label
...
for rep in range(n_rep):
    ...
    for lab in present_label:
        ...
        netG_A2B.conv1   = nn.Conv2d(nc, 64, 3, 1, 1, bias=False) 
...
res = (top1s, top3s, cover_accs, avg_counts)

import pickle

with open('FCI_Res34_fmnist.pkl', 'wb') as out:
    pickle.dump(res, out)
