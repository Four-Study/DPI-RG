...
class GeneratorA2B(nn.Module):
    ...
    def __init__(self, nc, nz):
        ...
        self.main = nn.Sequential(            
            ...
            nn.Tanh(),
            nn.AvgPool2d(kernel_size=2),
            nn.Conv2d(in_channels=16, out_channels=64, kernel_size=ks, stride=1),
            nn.Tanh(),
            nn.Flatten(),
            nn.Linear(in_features=64, out_features=128),
            nn.Tanh(),
            nn.Linear(in_features=128, out_features=nz)
        )
...
class GeneratorB2A(nn.Module):
    def __init__(self, nc=3, nz=8, ngf=32):
...
# class GeneratorB2A(nn.Module):
#     def __init__(self, nc=1, nz=8, ngf=32):
#         super(GeneratorB2A, self).__init__()
#         layers = [
#             # input is Z, going into a convolution
